...
2. TOUJOURS passer le parametre "date" au format YYYYMMDD lors des recherches (getTrips, getStopTimes)
...
2. ALWAYS pass the "date" parameter in YYYYMMDD format when searching (getTrips, getStopTimes)
